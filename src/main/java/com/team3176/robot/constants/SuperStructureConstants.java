...
public class SuperStructureConstants {
  ...
  public static final double ELEVATORLEADER_L2_POS = 30  + ELEVATORLEADER_ZERO_POS;
  public static final double ELEVATORLEADER_L3_POS = 55 + ELEVATORLEADER_ZERO_POS;
