...
public class RobotContainer {
    ...
    private final CommandJoystick transtick = new CommandJoystick(1);
    ...
    private void configureBindings() {
        ...
        drivetrain.setDefaultCommand(
            ...
            drivetrain.applyRequest(() ->
                drive.withVelocityX(-transtick.getY() * MaxSpeed) // Drive forward with negative Y (forward)
                    .withVelocityY(-transtick.getX() * MaxSpeed) // Drive left with negative X (left)
